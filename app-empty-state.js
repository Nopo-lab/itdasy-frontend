  ...
  window.emptyState = function (opts) {
    ...
    return `
      <div style="padding:36px 20px;text-align:center;">
        ...
        <div style="font-size:13px;color:#888;line-height:1.6;margin-bottom:18px;">${_esc(desc)}</div>
        ...
        ${sampleHint ? `<div style="font-size:13px;color:#aaa;margin-top:14px;line-height:1.5;">${_esc(sampleHint)}</div>` : ''}
      </div>
    `;
  };
