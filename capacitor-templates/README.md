...
2. **Bundle Identifier** — `com.y2do.itdasy` (`capacitor.config.json`과 일치)
3. **Capabilities 추가**:
   - Push Notifications
...
### Gradle 추가 작업
1. `android/app/build.gradle`의 `applicationId "com.y2do.itdasy"` 확인
...
4. iOS 앱 추가 — Bundle ID `com.y2do.itdasy`
