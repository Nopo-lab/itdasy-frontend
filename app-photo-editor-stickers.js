...
(function () {
  ...
  const PRESETS = {
    price: [
      ...
      { value: '신규 할인',  color: '#D58A95', size: 6, bg: false, stroke: true,  font: 'sans' },
    ],
    arrow: [
      ...
      { value: '➜ 예약',     color: '#D58A95', size: 7,  bg: false, stroke: true,  font: 'sans' },
    ],
    star: [
      ...
      { value: '인기',      color: '#D58A95', size: 7, bg: false, stroke: true,  font: 'serif' },
    ...
    service: [
      ...
      { value: 'NEW',       color: '#D58A95', size: 9, bg: false, stroke: true,  font: 'sans' },
    ...
    emotion: [
      { value: '♥',         color: '#D58A95', size: 11, bg: false, stroke: true,  font: 'sans' },
      { value: '♥♥♥',       color: '#D58A95', size: 8,  bg: false, stroke: true,  font: 'sans' },
      { value: '만족 ♥',     color: '#D58A95', size: 6,  bg: true,  stroke: false, font: 'hand' },
      { value: '✓ 완성',     color: '#ffffff', size: 7,  bg: true,  stroke: false, font: 'sans' },
      { value: '예뻐요!',    color: '#D58A95', size: 7,  bg: false, stroke: true,  font: 'hand' },
    ],
    event: [
      ...
      { value: '한정',      color: '#D58A95', size: 9,  bg: false, stroke: true,  font: 'sans' },
