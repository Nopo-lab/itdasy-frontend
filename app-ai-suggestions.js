    ...
    container.innerHTML = `
      <div style="background:linear-gradient(135deg,rgba(241,128,145,.08),rgba(241,128,145,.02));border:1px solid rgba(241,128,145,.18);border-radius:14px;padding:12px 14px;">
        <div style="display:flex;align-items:center;gap:6px;margin-bottom:8px;">
          ...
          <strong style="font-size:13px;color:#D95F70;">AI 추천 · 오늘 할 일</strong>
        </div>
    ...
    container.innerHTML = `
      <div style="background:linear-gradient(135deg,rgba(241,128,145,.08),rgba(241,128,145,.02));border:1px solid rgba(241,128,145,.18);border-radius:14px;padding:12px 14px;">
        <div style="display:flex;align-items:center;gap:6px;margin-bottom:10px;">
          <span style="font-size:13px;">✨</span>
          <strong style="font-size:13px;color:#D95F70;letter-spacing:.3px;">AI 추천 · 오늘 할 일</strong>
        </div>
        ${d.items.map((it, i) => `
