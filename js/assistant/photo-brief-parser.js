...
(function () {
  ...
  /* [2026-09-13 ZH ITBI] '문구 좀 더 크게' 가 편집 지시로 안 걸려 **문장 통째가 시술내용·글자**가 됐다
     (사진 위에 "문구 좀 더 크게" 가 박히고 캡션 시술도 그걸로). 크기·이동 지시어와 '문구'/'글씨' 단독도 편집 지시로 본다. */
  var EDIT_RE = /텍스트|글씨|글자|타이포|시술내용|문구|스티커|이모지|데코|꾸며|꾸미|붙여|좌측|우측|왼쪽|오른쪽|좌상|좌하|우상|우하|하단|상단|아래|위쪽|가운데|중앙|밝게|어둡게|보정|누끼|배경|레이아웃|편집|덕지덕지|넣어|추가해|올려\s*줘|크게|작게|키워|줄여|내려|옮겨/;
