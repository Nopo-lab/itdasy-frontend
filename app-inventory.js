...
(function () {
  ...
  function _ensureSheet() {
    ...
    sheet.innerHTML = `
      <header class="dt-hdr">
        <button class="dt-back" data-inventory-close aria-label="뒤로"><svg width="20" height="20" aria-hidden="true"><use href="#ic-chevron-left"/></svg></button>
  ...
  function _openAddForm(id) {
    ...
    listEl.innerHTML = `
      ...
      <button data-inventory-back class="dt-back" style="margin-bottom:12px;" aria-label="뒤로"><svg width="20" height="20" aria-hidden="true"><use href="#ic-chevron-left"/></svg></button>
