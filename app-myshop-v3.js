...
(function () {
  ...
  function _renderHubMenu() {
    ...
    const items = [
      ...
      _menuItemHTML({ act: 'settings', iconClass: 'ms-menu__icon--gray', iconSVG: '<svg width="20" height="20" aria-hidden="true"><use href="#ic-settings"/></svg>', name: '설정', meta: '샵정보 · 데이터 · 백업' }),
    ].join('');
